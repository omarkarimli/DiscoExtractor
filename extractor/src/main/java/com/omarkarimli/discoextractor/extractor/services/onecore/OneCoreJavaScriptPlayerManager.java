 ...
 * </p>
 */
public final class OneCoreJavaScriptPlayerManager {
    ...
    private OneCoreJavaScriptPlayerManager() {
    }
    ...
    public static Integer getSignatureTimestamp(@Nonnull final String videoId)
        ...
        try {
            ...
            final String playerCode = OneCoreJavaScriptExtractor.extractJavaScriptPlayerCode(videoId);
            cachedSignatureTimestamp = Integer.valueOf(OneCoreSignatureUtils.getSignatureTimestamp(playerCode));
    ...
    public static String deobfuscateSignature(@Nonnull final String videoId,
        ...
        return OneCoreApiDecoder.decodeSignature(cachedPlayerId, obfuscatedSignature);
    }
    ...
    public static String getUrlWithThrottlingParameterDeobfuscated(
        ...
        final String obfuscatedThrottlingParameter =
                OneCoreThrottlingParameterUtils.getThrottlingParameterFromStreamingUrl(
                        streamingUrl);
        ...
        final String deobfuscatedThrottlingParameter = OneCoreApiDecoder.decodeThrottlingParameter(
    ...
    public static int getThrottlingParametersCacheSize() {
        return OneCoreApiDecoder.getCacheSize();
    }
     ...
     */
    @Nonnull
    public static OneCoreApiDecoder.BatchDecodeResult deobfuscateBatch(
            @Nonnull final String videoId,
            @Nullable final List<String> signatures,
            @Nullable final List<String> throttlingParams) throws ParsingException {
        extractPlayerIdIfNeeded(videoId);
        return OneCoreApiDecoder.decodeBatch(cachedPlayerId, signatures, throttlingParams);
    }
    ...
    private static void extractPlayerIdIfNeeded(@Nonnull final String videoId)
        ...
        if (cachedPlayerId == null) {
            cachedPlayerId = OneCoreJavaScriptExtractor.extractPlayerId(videoId);
        }
    }
}
