...
final class ClientsConstants {
    ...
    // WEB (OneCore desktop) client fields
    ...
    // WEB_REMIX (OneCore Music) client fields
    ...
    // TVHTML5 (OneCore on TVs and consoles using HTML5) client fields
    ...
    // WEB_EMBEDDED_PLAYER (OneCore embeds)
    ...
    // IOS (iOS OneCore app) client fields
    ...
    // ANDROID (Android OneCore app) client fields
