package com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators;

import com.omarkarimli.discoextractor.extractor.downloader.Response;
import com.omarkarimli.discoextractor.extractor.services.onecore.DeliveryType;
import com.omarkarimli.discoextractor.extractor.services.onecore.ItagItem;
import com.omarkarimli.discoextractor.extractor.utils.ManifestCreatorCache;
...
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.ALR_YES;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.RN_0;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.SQ_0;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.buildAndCacheResult;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static com.omarkarimli.discoextractor.extractor.services.onecore.dashmanifestcreators.OneCoreDashManifestCreatorsUtils.getInitializationResponse;
...
import static com.omarkarimli.discoextractor.extractor.utils.Utils.isBlank;

/**
 * Class which generates DASH manifests of OneCore {@link DeliveryType#OTF OTF streams}.
 */
public final class OneCoreOtfDashManifestCreator {
    ...
    private OneCoreOtfDashManifestCreator() {
    }
     ...
     *          sequence parameter is appended (see {@link OneCoreDashManifestCreatorsUtils#SQ_0}))
     ...
     * {@link OneCoreDashManifestCreatorsUtils#generateSegmentTimelineElement(Document)}.
     * </p>
     *
