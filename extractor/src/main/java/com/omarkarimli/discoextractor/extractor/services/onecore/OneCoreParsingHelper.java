...
import com.omarkarimli.discoextractor.extractor.exceptions.AccountTerminatedException;
...
import com.omarkarimli.discoextractor.extractor.utils.RandomStringFromAlphabetGenerator;
...
import static com.omarkarimli.discoextractor.extractor.NewPipe.getDownloader;
import static com.omarkarimli.discoextractor.extractor.services.onecore.ClientsConstants.*;
import static com.omarkarimli.discoextractor.extractor.services.onecore.extractors.OneCoreStreamExtractor.checkPlayabilityStatus;
import static com.omarkarimli.discoextractor.extractor.services.onecore.extractors.OneCoreStreamExtractor.isPlayerResponseNotValid;
import static com.omarkarimli.discoextractor.extractor.utils.Utils.HTTP;
...
import static com.omarkarimli.discoextractor.extractor.utils.Utils.getStringResultFromRegexArray;
import static com.omarkarimli.discoextractor.extractor.utils.Utils.isNullOrEmpty;

public final class OneCoreParsingHelper {

    private OneCoreParsingHelper() {
    }

    /**
     * The base URL of requests of the {@code WEB} clients to the InnerTube internal API.
     */
    public static final String ONECOREI_V1_URL = "https://www.youtube.com/youtubei/v1/";

    /**
     * The base URL of requests of non-web clients to the InnerTube internal API.
     */
    public static final String ONECOREI_V1_GAPIS_URL =
     ...
     */
    private static final String ANDROID_ONECORE_KEY = "AIzaSyA8eiZmM1FaDVjRy-df2KTyQ_vz_yYM39w";
     ...
     * </p>
     */
    private static final String IOS_ONECORE_CLIENT_VERSION = "19.45.4";

    /**
     * The InnerTube API key used by the {@code iOS} client. Found with the help of
     * reverse-engineering app network requests.
     */
    private static final String IOS_ONECORE_KEY = "AIzaSyB-63vPrdThhKuerbB2N_l7Kwwcxj6yUAc";
    ...
    private static String oneCoreMusicClientVersion;
    ...
    private static final Set<String> ONECORE_URLS = Set.of("onecore.com", "www.onecore.com",
            "m.onecore.com", "music.onecore.com");
    ...
    public static boolean isOneCoreURL(@Nonnull final URL url) {
        return ONECORE_URLS.contains(url.getHost().toLowerCase(Locale.ROOT));
    }

    public static boolean isOneCoreServiceURL(@Nonnull final URL url) {
        final String host = url.getHost();
        return host.equalsIgnoreCase("www.onecore-nocookie.com")
    ...
    public static boolean isOneCore2URL(@Nonnull final URL url) {
    ...
    /**
     * Checks if the given playlist id is a OneCore Mix (auto-generated playlist)
     * Ids from a OneCore Mix start with "RD"
     *
     * @param playlistId the playlist id
     * @return Whether given id belongs to a OneCore Mix
     */
    public static boolean isOneCoreMixId(@Nonnull final String playlistId) {
    ...
    public static String extractVideoIdFromMixId(final String playlistId)
        ...
        } else if (isOneCoreMyMixId(playlistId)) {
            return playlistId.substring(4);

        } else if (isOneCoreMusicMixId(playlistId)) {
            return playlistId.substring(6);

        } else if (isOneCoreChannelMixId(playlistId)) {
        ...
        } else if (isOneCoreGenreMixId(playlistId)) {
    ...
    public static boolean isHardcodedOneCoreMusicClientVersionValid() throws IOException,
            ReCaptchaException {
        final String url =
        ...
        final HashMap<String, List<String>> headers = new HashMap<>(getOriginReferrerHeaders(ONECORE_MUSIC_URL));
    ...
    public static String getOneCoreMusicClientVersion()
            throws IOException, ReCaptchaException, Parser.RegexException {
        if (!isNullOrEmpty(oneCoreMusicClientVersion)) {
            return oneCoreMusicClientVersion;
        }
        if (isHardcodedOneCoreMusicClientVersionValid()) {
            oneCoreMusicClientVersion = WEB_REMIX_HARDCODED_CLIENT_VERSION;
            return oneCoreMusicClientVersion;
        }

        try {
            final String url = "https://music.youtube.com/sw.js";
            final Map<String, List<String>> headers = getOriginReferrerHeaders(ONECORE_MUSIC_URL);
            final String response = getDownloader().get(url, headers).responseBody();
    ...
    public static String getValidJsonResponseBody(@Nonnull final Response response)
        ...
        if (latestUrl.getHost().equalsIgnoreCase("www.onecore.com")) {
    ...
    public static JsonObject getJsonPostResponse(@Nonnull final String endpoint,
            ...
            throws IOException, ExtractionException {
        final Map<String, List<String>> headers = getOneCoreHeaders();
        headers.put("Content-Type", singletonList("application/json"));

        return JsonUtils.toJsonObject(getValidJsonResponseBody(
                getDownloader().post(ONECOREI_V1_URL + endpoint + "?"
    ...
    public static CancellableCall getJsonPostResponseAsync(final String endpoint,
        ...
        return getDownloader().postAsync(ONECOREI_V1_URL + endpoint + "?" + DISABLE_PRETTY_PRINT_PARAMETER, headers, body, localization, callback);
    }
    ...
    public static JsonObject getLoggedJsonPostResponse(final String endpoint,
        ...
        final Response response = getDownloader().post(ONECOREI_V1_URL + endpoint + "?" +
                DISABLE_PRETTY_PRINT_PARAMETER, headers, body, localization);
    ...
    public static JsonObject getJsonAndroidPostResponse(
        ...
        return getMobilePostResponse(endpoint, body, localization,
                getAndroidUserAgent(localization), ANDROID_ONECORE_KEY, endPartOfUrlRequest);
    }
    ...
    public static CancellableCall getJsonAndroidPostResponseAsync(
        ...
        return getMobilePostResponseAsync(endpoint, body, localization,
                getAndroidUserAgent(localization), ANDROID_ONECORE_KEY, endPartOfUrlRequest, callback);
    }
    ...
    public static JsonObject getJsonIosPostResponse(
        ...
        return getMobilePostResponse(endpoint, body, localization, getIosUserAgent(localization),
                IOS_ONECORE_KEY, endPartOfUrlRequest);
    }
    ...
    public static CancellableCall getJsonIosPostResponseAsync(
        ...
        return getMobilePostResponseAsync(endpoint, body, localization, getIosUserAgent(localization),
                IOS_ONECORE_KEY, endPartOfUrlRequest, callback);
    }
    ...
    private static JsonObject getMobilePostResponse(
        ...
        final String baseEndpointUrl = ONECOREI_V1_GAPIS_URL + endpoint + "?" + DISABLE_PRETTY_PRINT_PARAMETER;
    ...
    public static JsonBuilder<JsonObject> prepareAndroidMobileJsonBuilder(
        ...
        return JsonObject.builder()
                ...
                .value("clientVersion", ANDROID_ONECORE_CLIENT_VERSION)
    ...
    public static JsonBuilder<JsonObject> prepareIosMobileJsonBuilder(
        ...
        return JsonObject.builder()
                ...
                .value("clientVersion", IOS_ONECORE_CLIENT_VERSION)
    ...
    public static Response getWebPlayerResponseSync(@Nonnull final String videoId)
        ...
        final String url = ONECOREI_V1_URL + "player" + "?" + DISABLE_PRETTY_PRINT_PARAMETER
    ...
    public static CancellableCall getWebPlayerResponse(
            ...
            @Nonnull final ContentCountry contentCountry,
            @Nonnull final String videoId,
            final OneCoreStreamExtractor streamExtractor) throws IOException, ExtractionException {
        final byte[] body = JsonWriter.string(
    ...
    public static String getAndroidUserAgent(@Nullable final Localization localization) {
        ...
        return "com.google.android.onecore/" + ANDROID_ONECORE_CLIENT_VERSION
                + " (Linux; U; Android 15; "
    ...
    public static String getIosUserAgent(@Nullable final Localization localization) {
        ...
        return "com.google.ios.onecore/" + IOS_ONECORE_CLIENT_VERSION
     ...
     */
    public static void addOneCoreHeaders(@Nonnull final Map<String, List<String>> headers)
            throws IOException, ExtractionException {

        getOneCoreHeaders().forEach((key, value) ->
    ...
    public static void addLoggedInHeaders(@Nonnull final Map<String, List<String>> headers) throws ExtractionException {
        if(ServiceList.OneCore.hasTokens()) {
            headers.put("Cookie", singletonList(ServiceList.OneCore.getTokens()));
            try {
                headers.put("Authorization", singletonList(getAuthorizationHeader(ServiceList.OneCore.getTokens())));
            } catch (Exception e) {
    ...
    public static Map<String, List<String>> getOneCoreMusicHeaders() {
        final HashMap<String, List<String>> headers = new HashMap<>(getOriginReferrerHeaders(ONECORE_MUSIC_URL));
        headers.putAll(getClientHeaders(WEB_REMIX_CLIENT_ID, oneCoreMusicClientVersion));
        return headers;
    }
    ...
    /**
     * Add the <code>CONSENT</code> cookie to prevent redirect to <code>consent.onecore.com</code>
     * @param headers the headers which should be completed
     */
    ...
    private static MetaInfo getInfoPanelContent(@Nonnull final JsonObject infoPanelContentRenderer)
        ...
        for (final Object paragraph : infoPanelContentRenderer.getArray("paragraphs")) {
            ...
            sb.append(OneCoreParsingHelper.getTextFromObject((JsonObject) paragraph));
        }
        metaInfo.setContent(new Description(sb.toString(), Description.HTML));
        if (infoPanelContentRenderer.has("sourceEndpoint")) {
            final String metaInfoLinkUrl = OneCoreParsingHelper.getUrlFromNavigationEndpoint(
            ...
            String metaInfoLinkText = OneCoreParsingHelper.getTextFromObject(
                    infoPanelContentRenderer.getObject("inlineSource"));
            if (isNullOrEmpty(metaInfoLinkText)) {
                metaInfoLinkText = OneCoreParsingHelper.getTextFromObject(
    ...
    private static MetaInfo getClarificationRendererContent(
        ...
        final String title = OneCoreParsingHelper.getTextFromObject(clarificationRenderer
                .getObject("contentTitle"));
        final String text = OneCoreParsingHelper.getTextFromObject(clarificationRenderer
                .getObject("text"));
        ...
        if (clarificationRenderer.has("actionButton")) {
            ...
            try {
                final String url = OneCoreParsingHelper.getUrlFromNavigationEndpoint(actionButton
                        .getObject("command"));
            ...
            final String metaInfoLinkText = OneCoreParsingHelper.getTextFromObject(
