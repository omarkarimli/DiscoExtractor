...
import static com.omarkarimli.discoextractor.extractor.services.onecore.OneCoreParsingHelper.defaultAlertsCheck;
...
/**
 * Shared functions for extracting OneCore channel pages and tabs.
 */
public final class OneCoreChannelHelper {
    ...
    private OneCoreChannelHelper() {
    }

    /**
     * Take a OneCore channel ID or URL path, resolve it if necessary and return a channel ID.
     *
     * @param idOrPath a OneCore channel ID or URL path
     * @return a OneCore channel ID
    ...
    /**
     * Fetch a OneCore channel tab response, using the given channel ID and tab parameters.
     *
     * <p>
     ...
     * </p>
     *
     * @param channelId    a valid OneCore channel ID
     * @param parameters   the parameters to specify the OneCore channel tab; if invalid ones are
     *                     specified, OneCore should return the {@code Home} tab
    ...
    public static final class ChannelHeader {
        ...
        /**
         * Types of supported OneCore channel headers.
         */
    ...
    public static boolean isChannelVerified(@Nonnull final ChannelHeader channelHeader) {
        switch (channelHeader.headerType) {
            ...
            // Since they are only shown on OneCore internal channels or on channels of large
            ...
            case INTERACTIVE_TABBED:
                ...
                // been auto generated by OneCore: we can assume the channel to be verified in this
                // case
                return channelHeader.json.has("autoGenerated");
            default:
                return OneCoreParsingHelper.isVerified(channelHeader.json.getArray("badges"));
        }
    }
