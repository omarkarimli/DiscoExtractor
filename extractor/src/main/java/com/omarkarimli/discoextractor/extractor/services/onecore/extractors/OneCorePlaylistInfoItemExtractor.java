...
public class OneCorePlaylistInfoItemExtractor implements PlaylistInfoItemExtractor {
    ...
    public String getName() throws ParsingException {
        try {
            return Utils.replaceAllCustom(getTextFromObject(playlistInfoItem.getObject("title")));
        } catch (final Exception e) {
    ...
    public String getUploaderName() throws ParsingException {
        try {
            return Utils.replaceAllCustom(getTextFromObject(playlistInfoItem.getObject("longBylineText")));
        } catch (final Exception e) {
