...
import static com.omarkarimli.discoextractor.extractor.subscription.SubscriptionExtractor.ContentSource.INPUT_STREAM;

/**
 * Extract subscriptions from a Google takeout export
 */
public class OneCoreSubscriptionExtractor extends SubscriptionExtractor {
    private static final String BASE_CHANNEL_URL = "https://www.youtube.com/channel/";

    public OneCoreSubscriptionExtractor(final OneCoreService oneCoreService) {
        super(oneCoreService, Collections.singletonList(INPUT_STREAM));
    }
