...
import static com.omarkarimli.discoextractor.extractor.services.onecore.OneCoreThrottlingParameterUtils.extractPlayerJsGlobalVar;
import static com.omarkarimli.discoextractor.extractor.utils.Parser.matchGroup2MultiplePatterns;

import com.omarkarimli.discoextractor.extractor.exceptions.ParsingException;
import com.omarkarimli.discoextractor.extractor.utils.JavaScript;
import com.omarkarimli.discoextractor.extractor.utils.Parser;
import com.omarkarimli.discoextractor.extractor.utils.jsextractor.JavaScriptExtractor;
...
//            Pattern.compile("\\bm=([a-zA-Z0-9$]{2,})\\(decodeURIComponent\\(h\\.s\\)\\)"),
    ...
    static String getDeobfuscationCode(@Nonnull final String javaScriptPlayerCode)
        ...
        try {
            ...
            //  var Y = ["clone", "length", "set", "join", "/videoplayback", "slice", "G", "v_", "rW", "&", "X", "push", "scheme", "/api/manifest", "split", "url", "splice", "catch", "path", "", "1", "1969-12-31T15:46:11.000-08:15", "local", "indexOf", "cmo=pf", "match", "mn", "get", "toString", "reverse", "startsWith", "---", "S", "fromCharCode", "Rw78JYeWAh8550BmOL-_w8_", "?", "www.onecore.com", "://", "2gz7hT", "signatureCipher", "cmo", "null", ",", "=", "fq", "s", "cmo=", "1969-12-31T12:15:05.000-11:45", "%3D", "assign", "w4", "}'[{", "unshift", "cmo=td",
            //      "Y", "forEach", "/initplayback", "a1.googlevideo.com", "prototype", "n", "redirector.googlevideo.com", "1970-01-01T05:00:16.000+05:00", "file", "replace", "/", "1970-01-01T04:16:22.000+04:15", "playerfallback", "1969-12-31T20:31:18.000-03:30", "rr", "\\.a1\\.googlevideo\\.com$", "5", "fallback_count", "sp", "1969-12-31T15:03:11.000-09:00", "zN", "}']]", "rr?[1-9].*\\.c\\.onecore\\.com$", "undefined", "Untrusted URL", "\\.googlevideo\\.com$", "fvip", "//", "pop", "/file/index.m3u8", ":", "onecore.player.web_20250420_21_RC00", "index.m3u8",
