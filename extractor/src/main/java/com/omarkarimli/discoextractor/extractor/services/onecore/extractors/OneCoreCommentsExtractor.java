...
public class OneCoreCommentsExtractor extends CommentsExtractor {
    ...
    public OneCoreCommentsExtractor(
    ...
    private void collectCommentItem(@Nonnull final JsonArray mutations,
        ...
        if (content.has("commentThreadRenderer")) {
            ...
            if (commentThreadRenderer.has(COMMENT_VIEW_MODEL_KEY)) {
                ...
                collector.commit(new OneCoreCommentsEUVMInfoItemExtractor(
                        commentViewModel,
