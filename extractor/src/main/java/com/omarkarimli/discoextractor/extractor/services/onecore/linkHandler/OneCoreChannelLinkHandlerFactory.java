...
public final class OneCoreChannelLinkHandlerFactory extends ListLinkHandlerFactory {

    private static final OneCoreChannelLinkHandlerFactory INSTANCE
            = new OneCoreChannelLinkHandlerFactory();
    ...
    private OneCoreChannelLinkHandlerFactory() {
    }

    public static OneCoreChannelLinkHandlerFactory getInstance() {
        return INSTANCE;
    }
     ...
     * {@code onecore.com/yourcustomname}.
     *
    ...
    /**
     * Checks whether the given path conforms to handle URLs like {@code onecore.com/@yourhandle}.
     *
     * @param splitPath the path segments array
    ...
    public String getId(final String url) throws ParsingException {
        try {
            ...
            if (!Utils.isHTTP(urlObj) || !(OneCoreParsingHelper.isOneCoreURL(urlObj)
                    || OneCoreParsingHelper.isInvidiousURL(urlObj)
                    || OneCoreParsingHelper.isHooktubeURL(urlObj))) {
