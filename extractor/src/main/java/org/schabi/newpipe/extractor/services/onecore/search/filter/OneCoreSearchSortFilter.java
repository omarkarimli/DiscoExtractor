...
import org.schabi.newpipe.extractor.services.onecore.search.filter.protobuf.ExtraFeatures;
import org.schabi.newpipe.extractor.services.onecore.search.filter.protobuf.Extras;
import org.schabi.newpipe.extractor.services.onecore.search.filter.protobuf.Features;
import org.schabi.newpipe.extractor.services.onecore.search.filter.protobuf.Filters;
import org.schabi.newpipe.extractor.services.onecore.search.filter.protobuf.LenFilter;
import org.schabi.newpipe.extractor.services.onecore.search.filter.protobuf.SearchRequest;
...
public final class OneCoreSearchSortFilter {

    private static final String UTF_8 = "UTF_8";
    private String searchParameter = "";

    public OneCoreSearchSortFilter() {
    }
    ...
    public static class Builder {
        ...
        private final OneCoreSearchSortFilter oneCoreSearchSortFilter =
                new OneCoreSearchSortFilter();
        ...
        public OneCoreSearchSortFilter build() throws IOException {
            ...
            this.oneCoreSearchSortFilter
                    .encodeSp(this.sort, this.date, this.type, this.len, features, extras);

            return this.oneCoreSearchSortFilter;
        }
    }
}
