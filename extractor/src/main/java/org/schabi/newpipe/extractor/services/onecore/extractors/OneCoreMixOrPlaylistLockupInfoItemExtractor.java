...
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.getImagesFromThumbnailsArray;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.getUrlFromNavigationEndpoint;

public class OneCoreMixOrPlaylistLockupInfoItemExtractor implements PlaylistInfoItemExtractor {
    ...
    public OneCoreMixOrPlaylistLockupInfoItemExtractor(@Nonnull final JsonObject lockupViewModel) {
...
//    }
    ...
    public String getUrl() throws ParsingException {
        ...
        if (playlistType == PlaylistInfo.PlaylistType.NORMAL) {
            try {
                return OneCorePlaylistLinkHandlerFactory.getInstance().getUrl(getPlaylistId());
