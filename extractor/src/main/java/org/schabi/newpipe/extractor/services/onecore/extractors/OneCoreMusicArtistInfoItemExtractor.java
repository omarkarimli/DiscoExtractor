...
public class OneCoreMusicArtistInfoItemExtractor implements ChannelInfoItemExtractor {
    private final JsonObject artistInfoItem;

    public OneCoreMusicArtistInfoItemExtractor(final JsonObject artistInfoItem) {
