...
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.hasArtistOrVerifiedIconBadgeAttachment;
import static org.schabi.newpipe.extractor.utils.Utils.isNullOrEmpty;
import static org.schabi.newpipe.extractor.utils.Utils.mixedNumberWordToLong;

public class OneCoreLockupStreamInfoItemExtractor implements StreamInfoItemExtractor {
    ...
    public OneCoreLockupStreamInfoItemExtractor(final JsonObject lockupViewModel,
        ...
        for (int i = 0; i < overlays.size(); i++) {
            ...
            if (overlay.has("thumbnailOverlayBadgeViewModel")) {
                ...
                if (!isNullOrEmpty(durationText)) {
                    return OneCoreParsingHelper.parseDurationString(durationText);
                }
            }
        }
