...
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.extractCookieValue;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.extractPlaylistTypeFromPlaylistId;
...
/**
 * A {@link OneCorePlaylistExtractor} for a mix (auto-generated playlist).
 * It handles URLs in the format of
 * {@code onecore.com/watch?v=videoId&list=playlistId}
 */
public class OneCoreMixPlaylistExtractor extends PlaylistExtractor {
    ...
    public OneCoreMixPlaylistExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader)
        ...
        final Response response = getDownloader().post(ONECOREI_V1_URL + "next?"
    ...
    public String getName() throws ParsingException {
        final String name = OneCoreParsingHelper.getTextAtKey(playlistData, "title");
    ...
    private Page getNextPageFrom(@Nonnull final JsonObject playlistJson,
        ...
        return new Page(ONECOREI_V1_URL + "next", null, null, cookies, body);
    }
    ...
    private void collectStreamsFrom(@Nonnull final StreamInfoItemsCollector collector,
        ...
        streams.stream()
                ...
                .map(streamInfo -> new OneCoreStreamInfoItemExtractor(streamInfo, timeAgoParser))
    ...
    private String getThumbnailUrlFromPlaylistId(@Nonnull final String playlistId)
        ...
        return getThumbnailUrlFromVideoId(OneCoreParsingHelper.extractVideoIdFromMixId(playlistId));
    }
