...
import static org.schabi.newpipe.extractor.services.onecore.linkHandler.OneCoreSearchQueryHandlerFactory.MUSIC_ALBUMS;
import static org.schabi.newpipe.extractor.services.onecore.linkHandler.OneCoreSearchQueryHandlerFactory.MUSIC_ARTISTS;
import static org.schabi.newpipe.extractor.services.onecore.linkHandler.OneCoreSearchQueryHandlerFactory.MUSIC_PLAYLISTS;
import static org.schabi.newpipe.extractor.services.onecore.linkHandler.OneCoreSearchQueryHandlerFactory.MUSIC_SONGS;
import static org.schabi.newpipe.extractor.services.onecore.linkHandler.OneCoreSearchQueryHandlerFactory.MUSIC_VIDEOS;
...
public class OneCoreMusicSearchExtractor extends OneCoreBaseSearchExtractor {
    private JsonObject initialData;

    public OneCoreMusicSearchExtractor(final StreamingService service,
                                       final SearchQueryHandler linkHandler) {
        super(service, linkHandler);
    }

    private String getSearchType() {
        final OneCoreFilters.MusicOneCoreContentFilterItem contentFilterItem =
    ...
    public void onFetchPage(@Nonnull final Downloader downloader)
            ...
            .object()
                .object("context")
                    .object("client")
                        ...
                        .value("clientVersion", getOneCoreMusicClientVersion())
                        .value("hl", "en-GB")
        ...
        final Map<String, List<String>> headers = getOneCoreMusicHeaders();
        ...
        videos.stream()
                ...
                .forEachOrdered(infoItem -> {
                    ...
                    switch (searchType) {
                        case MUSIC_SONGS:
                        case MUSIC_VIDEOS:
                            collector.commit(new OneCoreMusicSongOrVideoInfoItemExtractor(
                                    infoItem, descriptionElements, searchType));
                            break;
                        case MUSIC_ARTISTS:
                            collector.commit(new OneCoreMusicArtistInfoItemExtractor(infoItem));
                            break;
                        case MUSIC_ALBUMS:
                        case MUSIC_PLAYLISTS:
                            collector.commit(new OneCoreMusicAlbumOrPlaylistInfoItemExtractor(
                                    infoItem, descriptionElements, searchType));
                            break;
                    }
                });
