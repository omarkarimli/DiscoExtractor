...
public class OneCoreChannelInfoItemExtractor implements ChannelInfoItemExtractor {
    ...
    public OneCoreChannelInfoItemExtractor(final JsonObject channelInfoItem) {
    ...
    public String getUrl() throws ParsingException {
        try {
            ...
            return OneCoreChannelLinkHandlerFactory.getInstance().getUrl(id);
        } catch (final Exception e) {
    ...
    public boolean isVerified() throws ParsingException {
        return OneCoreParsingHelper.isVerified(channelInfoItem.getArray("ownerBadges"));
    }
