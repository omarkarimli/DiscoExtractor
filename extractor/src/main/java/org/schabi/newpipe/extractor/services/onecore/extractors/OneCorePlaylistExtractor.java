...
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.DISABLE_PRETTY_PRINT_PARAMETER;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.ONECOREI_V1_URL;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.addOneCoreHeaders;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.extractPlaylistTypeFromPlaylistUrl;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.fixThumbnailUrl;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.getJsonPostResponse;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.getTextFromObject;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.getUrlFromNavigationEndpoint;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.getValidJsonResponseBody;
import static org.schabi.newpipe.extractor.services.onecore.OneCoreParsingHelper.prepareDesktopJsonBuilder;
...
public class OneCorePlaylistExtractor extends PlaylistExtractor {
    ...
    public OneCorePlaylistExtractor(final StreamingService service,
    ...
    public void onFetchPage(@Nonnull final Downloader downloader) throws IOException,
        ...
        OneCoreParsingHelper.defaultAlertsCheck(browseResponse);
    ...
    private Page getNextPageFrom(final JsonArray contents)
        ...
        if (lastElement.has("continuationItemRenderer")) {
            ...
            return new Page(ONECOREI_V1_URL + "browse?" + DISABLE_PRETTY_PRINT_PARAMETER, body);
        }
        return null;
    }
    ...
    private void collectStreamsFrom(@Nonnull final StreamInfoItemsCollector collector,
        ...
        videos.stream()
                ...
                .map(video -> new OneCoreStreamInfoItemExtractor(
